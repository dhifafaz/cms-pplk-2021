    ...
    return {
        init: function() {
            ...
            jQuery("#menu").length > 0 && $("#menu").metisMenu(), jQuery(".metismenu > .mm-active ").each(function() {
                ...
                }), t(), jQuery(".dlab-demo-content").length > 0 && (new PerfectScrollbar(".dlab-demo-content"), $(".dlab-demo-trigger").on("click", function() {
...
jQuery(document).ready(function() {
    ...
    "use strict";
    dompet.load(), setTimeout(function() {
        dompet.handleMenuPosition()
    }, 1e3)
}), jQuery(window).on("resize", function() {
    "use strict";
    dompet.resize(), setTimeout(function() {
        dompet.handleMenuPosition()
    }, 1e3)
});